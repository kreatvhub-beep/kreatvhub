      ...
      <div className="container">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
              {quickLinks.map((link, idx) => (
                <a key={idx} href={link.href} style={{ fontSize: "0.85rem", color: "#94a3b8", transition: "color var(--transition-fast)" }} onMouseEnter={(e) => (e.target.style.color = "#ffffff")} onMouseLeave={(e) => (e.target.style.color = "#94a3b8")}>
                  {link.name}
                </a>
              ))}
            </div>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem", alignItems: "center", fontSize: "0.8rem", color: "#64748b" }}>
          ...
          <div style={{ display: "flex", gap: "1.5rem" }}>
            <a href="#" onMouseEnter={(e) => (e.target.style.color = "#94a3b8")} onMouseLeave={(e) => (e.target.style.color = "#64748b")}>Privacy Policy</a>
            <a href="#" onMouseEnter={(e) => (e.target.style.color = "#94a3b8")} onMouseLeave={(e) => (e.target.style.color = "#64748b")}>Terms of Service</a>
          </div>
        </div>
